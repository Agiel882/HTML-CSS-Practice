window.onload=function(){
    ...
    var createReview=function(event){
        ...
        nameHeader.appendChild(name);ratingParagraph.appendChild(rating);
        ...
        reviewElements.forEach(function(el){reviewElement.appendChild(el);
        });
        reviewElement.id=name.textContent+'_review';
        reviewElement.className='user_review';return reviewElement;
    };
